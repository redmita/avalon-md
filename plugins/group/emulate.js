...
const thumb = 'https://raw.githubusercontent.com/redmita/json-db/main/avalonbot/media/avatar_contact.jpg'
...
let handler = async (m, { conn, usedPrefix, command, args, participants }) => {
	...
	if (/welcome|leave|bye/.test(tx)) {
		...
		let bg = `https://raw.githubusercontent.com/redmita/json-db/main/avalonbot/media/picbot/menus/menus_${meh}.jpg`
