...
const defaultMenu = {
	before: `
Genshin Impact JSON data with a robust searching API! Updated to version 5.3. Sources from the fandom wiki and GenshinData repo.
...
let handler = async (m, { conn, usedPrefix: _p, __dirname }) => {
	try {
		...
		let nais = `https://raw.githubusercontent.com/redmita/json-db/main/avalonbot/media/picbot/genshin/genshin_${meh}.jpg`
